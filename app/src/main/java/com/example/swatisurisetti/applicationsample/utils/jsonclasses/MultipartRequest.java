...
public class MultipartRequest extends Request<JSONObject> {
	...
	private HashMap<String, File> mAttachFileList;

	public MultipartRequest(String url, Response.ErrorListener errorListener,
			Response.Listener<JSONObject> listener, String key, File file,
			Bundle parameters) {
	...
	public MultipartRequest(String url, Response.ErrorListener errorListener,
			Response.Listener<JSONObject> listener, String key, String[] file,
			File filePart, Bundle parameters,
			HashMap<String, File> mAttachFileList2) {
		super(Method.POST, url, errorListener);
		mListener = listener;
		mAttachFileList = mAttachFileList2;
		buildMultipartEntity(parameters, true);
	}

	public MultipartRequest(String url, Response.ErrorListener errorListener,
			Response.Listener<JSONObject> listener, String key, File filePart,
			Bundle parameters, HashMap<String, File> mAttachFileList2) {
	...
	private void buildMultipartEntity(Bundle parameters, boolean isMutliple) {
		entity = encodePOSTUrl(entity, parameters);
